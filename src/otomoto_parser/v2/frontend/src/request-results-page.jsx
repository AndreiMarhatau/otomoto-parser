...
import { Breadcrumbs, IconButton, Shell, buildPageItems } from "./layout";
...
import { closeResultsModal, useResultsPagingEffects, useResultsPollingEffects } from "./use-request-results-effects";
...
export function RequestResultsPage() {
  ...
  useResultsPagingEffects({ currentPage: dataState.currentPage, totalPages: dataState.results?.pagination?.totalPages || 1, safePage: dataState.results?.pagination?.page || 1, setCurrentPage: dataState.setCurrentPage, listTopRef, previousPageRef, paginationScrollRafRef });
  useResultsPollingEffects({ requestId, reportState, redFlagState, setRedFlagState, loadRedFlagState, updateVehicleReportResultItem: dataState.updateVehicleReportResultItem });
